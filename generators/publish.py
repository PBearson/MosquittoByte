...
class PublishProperties(Packet):
    def __init__(self):
        ...
        self.topic_alias = self.toBinaryData(0x23, 2, True, 8, 1)
        self.appendPayloadRandomly(self.topic_alias)

        self.response_topic_length = random.randint(1, 30)
        ...
        self.subscription_identifier_value = random.randint(1, 268435455)
        ...
        self.content_type_length = random.randint(1, 30)
...
class Publish(Packet):
    def __init__(self):
        ...
        self.publish_message_length = random.randint(1, 100)
